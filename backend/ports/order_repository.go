...
type OrderRepository interface {
	...
	FindMatchesMarket(order *models.Order, limit int, offset int) ([]*models.Order, error)
	FindMatchesLimit(order *models.Order, price float64, limit int, offset int) ([]*models.Order, error)
